...
new_excel_code = """let wb = new ExcelJS.Workbook();
        ...
        Object.keys(PIPELINE.sheets).forEach(k => {
            ...
            let titleRow2 = ws.addRow([`Base Layer: ${s.lyrA}  |  Target Layer: ${s.lyrB}  |  Total Cut: ${Number(s.totalCut.toFixed(2))} m³  |  Total Fill: ${Number(s.totalFill.toFixed(2))} m³`]);
